...
export default function App() {
                            ...
                            <>
                                ...
                                <Dropdown shouldBlockScroll={false}>
                                    ...
                                    <DropdownMenu aria-label="Opciones de exportación">
                                        ...
                                        <DropdownItem key="complementario_entrevista" textValue="Entrevista Complementaria PDF" onPress={() => onExport("Reporte Complementario Entrevista PDF")}>
                                            Entrevista Complementaria PDF (Aula 02)
                                        </DropdownItem>
    ...
    return (
        ...
        >
            ...
            <TableBody
                emptyContent={
                    (dataLoading && !inscripcioNota.length) ? (
                ...
                items={(dataLoading && !inscripcioNota.length) ? [] : items}
                className="space-y-1"
            >
                {(item) => (
                    <TableRow
