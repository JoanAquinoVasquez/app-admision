                    ...
                    <div className="flex-1 overflow-y-auto lg:overflow-hidden h-full">
                        {isInscriptionOpen ? (
                            datosPago ? (
                                ...
                                <div className="flex flex-col lg:flex-row h-auto lg:h-full w-full p-3 lg:p-6 gap-6">

                                    {/* COLUMNA 2: Formulario de Pago - Centrado verticalmente en monitores grandes */}
                                    <div className="flex-[1.1] min-w-0 lg:h-full lg:overflow-y-auto pr-2 custom-scrollbar flex flex-col">
                                    ...
                                    {/* COLUMNA 3: Info del Voucher - Ahora visible en móvil también */}
                                    <div className="flex-[0.9] min-w-0 lg:h-full flex flex-col py-2">
                                        <div className="flex-1 bg-gray-50/80 border border-gray-100 rounded-3xl lg:rounded-[3rem] shadow-inner overflow-hidden">
                            ...
                            <div className="flex flex-col lg:flex-row w-full h-auto lg:h-full p-4 lg:p-10 gap-10 items-stretch overflow-y-auto lg:overflow-hidden">

                                <div className="w-full lg:flex-[3] flex flex-col justify-center bg-gray-50/50 rounded-[3.5rem] p-8 lg:overflow-y-auto shadow-inner border border-gray-100">
                                ...
                                <div className="w-full lg:flex-[2] h-[300px] lg:h-full relative">
