...
const NotAuthorizated = () => {
    return (
        <div className="flex flex-col items-center justify-center min-h-[700px] text-center bg-gray-100 relative py-10">
            {/* Barra superior */}
            <img
                src={topBarImage}
            ...
            <div className="px-4 flex flex-col sm:flex-row sm:justify-between sm:w-full sm:max-w-screen-lg items-center sm:space-x-8 space-y-6 sm:space-y-0">
                ...
                <div className="text-center w-full">
                    ...
                    <p className="text-3xl text-gray-600 mb-6 mt-4">
                        Oops! No estás autorizado para acceder a esta parte del
                        Sistema.
                    </p>
                    <Link
                        to="/"
